...
watch(
  () => props.body,
  (newValue) => {
    console.log("body changed", newValue);
    if (newValue == null) {
      bodyType.value = "none";
      body!.value = newValue;
    } else {
...
<template>
  <div class="flex flex-wrap gap-3">
    ...
    <div class="flex align-items-center">
      <RadioButton
        disabled
        v-model="bodyType"
        inputId="x-www-form-urlencoded"
        name="BodyType"
        value="x-www-form-urlencoded"
      />
      <label for="x-www-form-urlencoded" class="ml-2"
  ...
  <div id="formBody" v-if="bodyType.includes('form-')">
    TODO: Translate body to table-friendly form
  </div>
